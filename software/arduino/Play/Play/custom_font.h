/* This is a customized version of font8x8 that comes withssd1306ascii library,
 * the last characters have been changed in order to have some relevant icons
 * available.
 */
#ifndef CUSTOM_FONT_H
#define CUSTOM_FONT_H

GLCDFONTDECL(custom_font) = {
    0x00, 0x00, // size
    0x08, // width
    0x08, // height
    0x20, // first char
    ...
    0x00,0x1F,0x11,0x01,0x7D,0x39,0x13,0x00,  // '$', changed to loop
    ...
    0x60,0x9C,0x82,0xE1,0x99,0x82,0x9C,0x60,  // '*', changed to metronome
    ...
    0x00,0x1C,0x1C,0x1C,0x3E,0x1C,0x08,0x00,  // ':', changed to menu
    0x00,0x00,0x80,0x64,0x00,0x00,0x00,0x00,  // ;
    0x00,0x00,0x3E,0x00,0x3E,0x1C,0x08,0x00,  // '<', changed to decreased tempo
    0x00,0x28,0x28,0x28,0x28,0x28,0x00,0x00,  // =
    0x00,0x3E,0x1C,0x08,0x3E,0x1C,0x08,0x00,  // '>', changed to increased tempo
    0x00,0x04,0x02,0x02,0x52,0x0A,0x04,0x00,  // ?
    0x00,0x00,0x06,0xDF,0xDF,0x06,0x00,0x00,  // '@', changed to error
    ...
    0x00,0x3E,0x1C,0x08,0x00,0x2A,0x2A,0x2A,  // '^', changed to Autoplay
    ...
    0x00,0x7E,0x7E,0x3C,0x3C,0x18,0x18,0x00,  // '{', changed to Play
    0x00,0x7E,0x7E,0x00,0x00,0x7E,0x7E,0x00,  // '|', changed to Pause
    0x00,0x7E,0x7E,0x7E,0x7E,0x7E,0x7E,0x00,  // '}', changed to Stop
    0x00,0x20,0x50,0x3E,0x02,0x04,0x00,0x00,  // '~', changed to Note
};
