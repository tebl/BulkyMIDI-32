...
encoding utf-8
Sheet 1 1
Title "BulkyMIDI-32 Mk7 Adapter"
Date ""
Rev "A"
Comp ""
Comment1 ""
Comment2 "other keyboards with a similar DB15-connector."
Comment3 "The adapter was created for used with an Evolution Mk7 keyboard, but it may work for"
Comment4 "Gameport to MIDI, note that this replaces the gameport instead of plugging into one."
$EndDescr
$Comp
L Device:C_Small C1
U 1 1 62E57D8A
...
MIDI IN (optional)
$Comp
L gameport:Gameport_DB15_Female J1
U 1 1 620AD515
P 3675 3275
F 0 "J1" H 4163 4267 50  0000 C CNN
F 1 "Gameport" H 4163 4176 50  0000 C CNN
F 2 "RND_DSUB:DSUB-15_Female_Vertical_Pitch2.77x2.84mm" H 3675 3275 50  0001 C CNN
...
U 1 1 620CCE57
P 4575 3450
F 0 "#PWR0102" H 4575 3200 50  0001 C CNN
...
F 3 "http://www.ti.com/lit/gpn/sn74ls00" H 6650 4425 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 4125 3275 2    50   Input ~ 0
MIDI_RxD
Wire Wire Line
	9275 2150 9350 2150
...
F 3 "~" H 6775 2050 50  0001 C CNN
	...
	0    1    1    0   
$EndComp
Text GLabel 4125 2675 2    50   Output ~ 0
MIDI_TxD
Wire Wire Line
	3975 3175 4575 3175
Wire Wire Line
...
U 1 1 620B2F56
P 4725 2125
F 0 "#PWR0101" H 4725 1975 50  0001 C CNN
F 1 "+5V" H 4725 2265 50  0000 C CNN
...
U 1 1 5E61D3D0
P 2825 6500
F 0 "J4" H 2904 6825 50  0000 C CNN
F 1 "DC IN" H 2904 6734 50  0000 C CNN
F 2 "BulkyMIDI-32:BARREL_JACK" H 2875 6460 50  0001 C CNN
F 3 "~" H 2875 6460 50  0001 C CNN
	1    2825 6500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E61DE6E
P 3800 7150
F 0 "#PWR0107" H 3800 6900 50  0001 C CNN
...
U 1 1 5F9F946B
P 3800 6500
F 0 "C2" H 3915 6546 50  0000 L CNN
F 1 "470uF" H 3915 6455 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D8.0mm_P3.50mm" H 3800 6500 50  0001 C CNN
...
U 1 1 623726BF
P 3200 6000
F 0 "SYM1" H 3200 6221 50  0001 C CNN
F 1 "DC 5V" H 3200 6129 50  0000 C CNN
F 2 "BulkyMIDI-32:PWR_Specification" H 3075 6100 50  0001 C CNN
...
U 1 1 62EEB06E
P 4725 2275
F 0 "JP1" V 4775 2550 50  0000 R CNN
F 1 "VCC_EN" V 4700 2625 50  0000 R CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Open_Pad1.0x1.5mm" H 4725 2275 50  0001 C CNN
F 3 "~" H 4725 2275 50  0001 C CNN
	1    4725 2275
	0    -1   -1   0   
$EndComp
Text Notes 2200 1900 0    50   ~ 0
Evolution Mk7 keyboard does not provide power on any of the VCC\npins, so this must be supplied separately. You may link VCC_EN when\nused with similar keyboards that do provide power.
$Comp
L Device:D D2
U 1 1 62F582DA
P 3275 6400
F 0 "D2" H 3275 6183 50  0000 C CNN
F 1 "1n4001" H 3275 6274 50  0000 C CNN
F 2 "Diode_THT:D_DO-41_SOD81_P10.16mm_Horizontal" H 3275 6400 50  0001 C CNN
